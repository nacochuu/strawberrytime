...
function setHeader() {
  ...
  const headerPc = /* HTML */ `
    ...
    <div class="pc header fbc w100p h164 bgF9E8ED fixed top0 z200">
...
function setFooter() {
  ...
  footer.outerHTML = /* HTML */ `
    <div class="pc  w100p footer fcc z100 bgF9E8ED py80">
      <div class="fxc">
    ...
    <div class="sp footer fcc z100 w100p bgF9E8ED py60">
      <div class="v fxc">
